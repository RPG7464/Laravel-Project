...
<title>The Easiest Way to Add Input Masks to Your Forms</title> <link
    ...
    <body>
        <div class="registration-form">
            <form method="POST" action="{{route ('validar-registro')}}">
                ...
                <div class="form-group">
                    <select class="form-control item" name="role" id="role">
                        <option value="admin">Admin</option>
                        <option value="user">User</option>
                    </select>
                </div>
                <button type="submit" class="btn btn-block mt-2 create-account">Create Account</button>
        </div>
        </form>
